        ...
        <div className='bg-white w-screen flex flex-col justify-center px-8 lg:px-28 pb-4 lg:h-screen lg:justify-start lg:w-[60%]'>
            ...
            <div className='lg:p-12'>
                ...
                <div className='flex flex-col justify-start items-start my-6 space-y-4'>
                    ...
                    <button className='text-primary bg-secondary w-full rounded text-center h-14 lg:h-10 lg:text-sm'>Login In</button>
                    <div className='flex space-x-1'>
                        <p className='opacity-80 lg:text-sm'>Not a user yet?</p>
                        <Link to='/signup' className='text-blue-500 underline font-bold lg:text-sm'>Sign up</Link>
                    </div>
                </div>
            </div>
